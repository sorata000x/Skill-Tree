    ...
    >
      {!linkInputOpen ? (
        <div onBlur={(e) => close()}>
          ...
          <button onClick={(e) => applyStyle("BOLD")}>
            <MdFormatBold size={18} />
          </button>
          <button onClick={(e) => applyStyle("ITALIC")}>
            <MdFormatItalic size={18} />
          </button>
          <button onClick={(e) => applyStyle("UNDERLINE")}>
            <MdFormatUnderlined size={18} />
          </button>
          <button onClick={(e) => applyStyle("STRIKETHROUGH")}>
            <MdStrikethroughS size={18} />
          </button>
          <button
            onClick={(e) => applyStyle("CODE")}
        ...
        <div>
          ...
          <button
            onMouseDown={(e) => e.preventDefault()}
            onClick={(e) => applyLink(e, linkValue)}
          >
            <AiOutlineLink size={16} />
          </button>
        </div>
